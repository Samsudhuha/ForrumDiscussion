...
<form method="POST" action="{{ url('/update/'.$data->id) }}"  enctype="multipart/form-data" id="addpost">
    {{ csrf_field() }}
    <div class="posttweetcontainer">
        ...
        <div class="posttweettacontainer" style="margin-left: 50px;">
            <input name="nama" style="margin-bottom:10px; border-radius: 8px;" type="text" class="form-control" value="{{$data->nama}}" required>
            <textarea name="isi" rows="3" class="form-control" required>{{$data->isi}}</textarea>
